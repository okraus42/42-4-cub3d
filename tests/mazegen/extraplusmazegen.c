...
/*   Updated: 2023/11/05 13:39:38 by okraus           ###   ########.fr       */
/*                                                                            */
/* ************************************************************************** */
...
// 		{
// 			m->i = rand() % (m->s);
// 			if ((m->map[m->i] & 4) || (m->map[m->i] == ROOM_B))
// 				break;
// 		}
// 		m->rw = (rand() % 4) * 2 + 3;
// 		m->rh = (rand() % 4) * 2 + 3;
...
// 		{
// 			++(m->d);
// 			keep_flooding(m, m->i, FLOOD_A + m->d);
// 		}
// 		++m->i;
// 	}
// 	start_flooding(m);
...
int	main(int ac, char *av[])
{
	...
	**/
	...
	add_rooms6(&m);
	map_print("added rooms" , &m);
	//open rooms
	map_print("???opened rooms???" , &m);
	//trim deadends
